...
class EchoLlmProvider extends LlmProvider with ChangeNotifier {
  /// Creates an [EchoLlmProvider] instance with an optional chat history.
  ///
  ...
  EchoLlmProvider({Iterable<ChatMessage>? history})
