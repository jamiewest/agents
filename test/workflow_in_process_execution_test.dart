...
void main() {
  group('InProcessExecutionEnvironment', () {
    ...
    test('explicit context sends deliver to target executor', () async {
      ...
      final run = await inProcessExecution.runAsync(workflow, 'hello');
    ...
    test('stream async captures emitted events', () async {
      ...
      final run = await inProcessExecution.streamAsync(workflow, input: 'x');
